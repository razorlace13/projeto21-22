...
--
-- Host: 127.0.0.1
-- Tempo de geração: 07-Jan-2022 às 14:10
...
INSERT INTO `consumo` (`id_consumo`, `id_pedido`, `id_product`, `quantidade`) VALUES
(1, 4, 29, 1),
(2, 4, 1, 2),
(3, 5, 1, 2);
...
(1, 'teste', 'teste@hotmail.com', '$2y$13$LZp8IHiZAAhuo6DYZ67VquRmXUX./WHn/DK/D/yaVWz8xwffBM73y', '', 'F_Fu2do9PM8hdn0LCX4_YPpTtDgsJIZi', 10, 123456789, 123456789, 1638525375, 1641311638, 'jDJ46cObc0XYnf-Rthb0jVoYMCkcaDbf_1638525375');
...
--
ALTER TABLE `consumo`
  MODIFY `id_consumo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `purchases`
  MODIFY `id_purchase` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=241;
